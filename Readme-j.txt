...
--------------------------【重要】--------------------------
シリアル番号の設定は、複数のHIDaspxを利用する場合には、非常に重要な項目です。
その理由は、同一の VID/PID, シリアル番号の HIDaspxが一台のパソコンに同時に
接続された瞬間、「Windowsが再起動する」という可能性があるのです。
これは、異なるシリアル番号を設定することで者問題を解決できます。
複数台のHIDaspxを利用する可能性のある方は、ぜひ適正なシリアル番号を
設定してご利用ください。
--------------------------【重要】--------------------------
